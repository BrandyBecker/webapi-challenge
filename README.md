...
- express.json() parses incoming requests w/ JSON payloads and is based on `body-parser`
- express.Router([options]) creates a new router object.

- [x] Describe Middleware? 
- Middleware is like a bridge between an os/database and applications.

- [x] Describe a Resource?
- A resource is an object with a type, associated data, relationships to other resources, and a set of methods that operate on it.

- [x] What can the API return to help clients know if a request was successful?
- A status code with a message saying `this: was sucessful !`

- [x] How can we partition our application into sub-applications?
- We can partition our application into sub-applications by using routes, server.use, module.exports, and requires('")s.
